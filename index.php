<?php
ob_start();
define('API_KEY','243815250:AAHNn8tHn5wMczdIupNzp9WvXWgl0QfLu7M');
$the_admin_id = 206189568;
                ...
                'results' => json_encode([[
                    ...
                    [
                        ...
                        'input_message_content'=>[
                            'message_text'=>'@create_inlinekaybord_bot getlist-'.$theListId
                        ]
                    ]])
            ]));
        }else{
...
<pre>@create_inlinekaybord_bot d6cdbea45b238632bdd6d11dcf7fe98f </pre>
...
<code>@create_inlinekaybord_bot getlist-XXXXX </code>
...
👈  حالا برای من کد inline تان را بفرستید : ( فعلا فقط لیست ها قبول هستند )".$cancel_Text,
                ...
                case '2':{
                    ...
                    if(str_replace('@create_inlinekaybord_bot getlist-','',$code) != $code){
                        $code_list = trim(str_replace('@create_inlinekaybord_bot getlist-','',$code));
...
اگر بد توضیح دادم روی /help کلیک کن راهنمایی مفصل داره !'
                            ...
                            $theCommand = '@create_inlinekaybord_bot getlist-'.ListTab::getCurrentMakeID($update->message->from->id);
                            makeHTTPRequest('sendMessage',[
                                'chat_id'=>$update->message->from->id,
                                'text'=>$theCommand,
                                'reply_markup'=>json_encode([
...
اگر بد توضیح دادم روی /help کلیک کن راهنمایی مفصل داره !'
                    ...
                    $theCommand = '@create_inlinekaybord_bot getbanner-'.getCurrentMakeID($update->message->from->id);
                    makeHTTPRequest('sendMessage',[
                        'chat_id'=>$update->message->from->id,
                        'text'=>$theCommand,
                        'reply_markup'=>json_encode([
...
//                    ]);
//                    makeHTTPRequest('sendMessage',[
//                        'text'=>'@create_inlinekaybord_bot getbanner-'.getCurrentMakeID($userID),
//                        'chat_id'=>$userID
//                    ]);
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot243815250:AAHNn8tHn5wMczdIupNzp9WvXWgl0QfLu7M/'.trim($imag->result->file_path,"\\/");
